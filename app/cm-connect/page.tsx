...
const CM_CONTENT:ARC_LINK[] = [
   ...
   //      textBody: "Join my Patreon free tier to get the Static Bind epilogue, bonus art, and more. New content posted every month. See below for instructions on how to join for free. If you want to give Danil and Tiernan a little extra love, check out the paid membership levels!"
   //  },
    {
        id: "preorder",
        href: "",
                    ...
                    <div key={"audiobook"} className="flex flex-col gap-6 items-center text-center border-accent-purple border-t pt-12">
                     ...
                     <div key={"Join my Patreon"} className="flex flex-col gap-6 items-center text-center border-accent-purple border-t pt-12">
                        ...
                        <img
                           ...
                           alt={"Screenshot of the Patreon page with indicators on how to join the free tier"}
                           className="w-full object-contain hidden sm:block"
                        />
                        <img
                           src={"/img/patreon-free-tier-mobile.jpg"}
                           alt={"Screenshot of the Patreon page with indicators on how to join the free tier"}
                           className="w-full object-contain block sm:hidden"
                        />
                        <p>If you want to give Danil and Tiernan a little extra love, check out the paid membership levels!</p>
